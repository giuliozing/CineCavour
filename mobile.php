...
if($prenotabile){echo '<div class="container">
	<form id="modulo" action="elabora.php" class="m-auto" method="post" style="max-width:600px"><h3 class="my-4">Compila il modulo</h3>
		<hr class="my-4" />
        ...
        else echo "<h2 id='nonprenotabile'>Al momento non è possibile prenotare nessuna serata.
        <br>
